...
> **Project Status:** The backend database for Foxtrail has been shut down, so the live version of the app is no longer functional. Foxtrail completed its job by helping us finish as **runners-up in the KPN Pitch Challenge**. 🏆
>
> 🎥 [Watch the presentation video](https://drive.google.com/file/d/17XKplofTajxzntWYbbJWs7Ij9Ooj64ri/view?usp=sharing)

![2nd place](./assets/runners_up.jpg)
...
| :-------------------------------- | :-------- | :-------------------------------------------------------------------------------- |
| **Web**                           | Discontinued | Database shut down — live version no longer works                             |

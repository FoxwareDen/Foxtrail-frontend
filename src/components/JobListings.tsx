    ...
    return (
      <div className="min-h-screen flex items-center justify-center w-full bg-gradient-to-br from-[#2b303a] to-[#1a1f29]">
        <div className="text-center">
          ...
          <p className="text-xl font-medium text-[#eee5e9] mb-2">Discovering Opportunities</p>
          <p className="text-[#92DCE5] text-sm">Loading the latest job listings for you...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-[#92DCE5] max-w-2xl mx-auto">
              Discover your next career move from our curated collection of opportunities
            </p>
          </div>
        ...
        {loading && jobs.length > 0 && (
          <div className="flex justify-center mb-8">
            <div className="flex items-center space-x-3 bg-white/5 backdrop-blur-sm px-6 py-3 rounded-full border border-white/10">
              ...
              <span className="text-[#92DCE5] font-medium">Updating job listings...</span>
            </div>
          </div>
        )}
        ...
        {jobs.length === 0 && !loading ? (
          <div className="text-center py-16 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10">
            ...
            <h3 className="text-2xl font-bold text-[#eee5e9] mb-3">No Jobs Found</h3>
            ...
            <div className="flex justify-center space-x-4">
              ...
              <button
                onClick={() => {/* Clear filters logic if available */}}
                className="px-8 py-3 bg-white/10 text-[#eee5e9] border border-white/20 rounded-xl hover:bg-white/20 transition-all duration-300 font-semibold"
              >
                Clear Filters
              </button>
            </div>

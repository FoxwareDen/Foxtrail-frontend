...
const LoginPage: React.FC = () => {
  ...
  const LINKEDIN_OAUTH_URL = `https://your-project-ref.supabase.co/auth/v1/authorize?provider=linkedin_oidc&redirect_to=${encodeURIComponent('http://localhost:1420/dashboard')}`;
